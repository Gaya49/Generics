...
/* Per fare i confronti usiamo il metodo compareTo(), in modo da avere un confronto generale per tutti i T che
   implementano l'interfaccia Comparable<T> e che quindi hanno un metodo compareTo(). */
